              ...
              >
                <Pressable
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    backgroundColor:
                      activeTab === "curated" ? "#FFFFFF" : "transparent",
                    alignItems: "center",
                    shadowColor:
                      activeTab === "curated" ? "#000" : "transparent",
                    shadowOpacity: 0.05,
                    shadowRadius: 4,
                    shadowOffset: { width: 0, height: 2 },
                    elevation: activeTab === "curated" ? 2 : 0,
                  }}
                >
                  <Text
                    style={{
                      fontSize: 13,
                      fontWeight: activeTab === "curated" ? "700" : "500",
                      color: activeTab === "curated" ? "#1D1A27" : "#9B9BAF",
                    }}
                  >
                    Curated for You
                  </Text>
                ...
                <Pressable
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    backgroundColor:
                      activeTab === "tryon" ? "#FFFFFF" : "transparent",
                    alignItems: "center",
                    shadowColor: activeTab === "tryon" ? "#000" : "transparent",
                    shadowOpacity: 0.05,
                    shadowRadius: 4,
                    shadowOffset: { width: 0, height: 2 },
                    elevation: activeTab === "tryon" ? 2 : 0,
                  }}
                >
                  <Text
                    style={{
                      fontSize: 13,
                      fontWeight: activeTab === "tryon" ? "700" : "500",
                      color: activeTab === "tryon" ? "#1D1A27" : "#9B9BAF",
                    }}
                  >
                    Virtual Try-On
                  </Text>
                ...
                >
                  {personImage ? (
                    ...
                    <>
                      ...
                      <Text
                        style={{ marginTop: 4, fontSize: 13, color: "#9B9BAF" }}
                      >
          ...
          >
            ...
            >
              {isWorn ? (
                ...
                <Text
                  style={{ fontSize: 15, fontWeight: "700", color: "#161618" }}
                >
                  Wear This
                </Text>
              )}
