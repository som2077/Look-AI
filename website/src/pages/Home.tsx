...
const FAQ_ITEMS = [
  { q: 'How does the AI outfit recommendation work?', a: 'Look AI combines your wardrobe data, body type profile, local weather conditions, and upcoming schedule to generate outfit suggestions. Our AI understands color theory, occasion dress codes, and seasonal layering to create looks that actually work.' },
  { q: 'Is Look AI free to use?', a: 'Look AI offers a generous free tier that includes basic outfit recommendations and wardrobe digitization. For unlimited scans, advanced AI features, and priority recommendations, we offer affordable Pro plans.' },
  { q: 'How accurate is the clothing detection?', a: 'Our AI accurately detects clothing category, occasion, and dominant colors with over 90% accuracy. Background removal uses the same technology as remove.bg for clean, professional results.' },
  { q: 'Is there a limit on wardrobe items?', a: 'Free users can add up to 30 items to their digital wardrobe. Pro users get unlimited items, batch scanning, and advanced categorization features.' },
  { q: 'How does weather integration work?', a: 'Look AI uses Open-Meteo (a free, open-source weather API) to fetch forecasts based on your location. Our custom Comfort Score algorithm combines temperature, humidity, and wind speed to recommend the right fabric weight and breathability.' },
  { q: 'Is my data private and secure?', a: 'Absolutely. Your wardrobe photos and personal data are encrypted and stored securely. We use Clerk for authentication and Supabase with Row-Level Security policies. Your data is never shared with third parties.' },
]
