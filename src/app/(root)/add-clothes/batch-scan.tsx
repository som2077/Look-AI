    ...
    try {
      for (const item of itemsToSave) {
        ...
        addItem({
          ...
          customName: item.customName || aiData.name || "Wardrobe Item",
          brand: item.brand || aiData.brand || "",
          category: aiData.category || "Top",
          subCategory: aiData.subCategory || "Item",
          primaryColor: aiData.color || aiData.primaryColor || "Unknown",
          secondaryColors: [],
          pattern: "Solid",
          ...
          neckType: undefined,
          season: aiData.season || ["All Season"],
          occasion: aiData.occasion || ["Casual"],
          formalityScore: 5,
          versatilityTags: [],
