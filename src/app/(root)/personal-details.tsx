...
export default function PersonalDetailsScreen() {
  ...
  const fields: Field[] = [
    ...
    },
    {
      ...
      icon: <IconChevronDown size={24} color="#00000080" strokeWidth={1.5} />,
      editable: true,
      type: "select",
    },
    {
    ...
    },
    {
      ...
      icon: <IconBriefcase size={24} color="#00000080" strokeWidth={1.5} />,
      editable: true,
      type: "text",
    },
    {
      ...
      icon: <IconNotes size={24} color="#00000080" strokeWidth={1.5} />,
      editable: true,
      type: "text",
    },
  ];
