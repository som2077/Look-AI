...
keywords: ui-design, ux-design, mobile-first, visual-design, responsive, best-practices, components, ai
---
...
1. fake fintech dashboards with random charts
2. one pretty screen and then generic filler screens
3. too many floating cards
4. weak navigation logic
5. phone-sized websites
6. gradient-heavy dribbble clones
7. glassmorphism without purpose
8. tiny unreadable text
9. too much content above the fold
10. cloned onboarding screens
11. fake complexity instead of good mobile hierarchy
12. sterile flat backgrounds with no texture or visual atmosphere
13. generic palettes
14. default purple-blue startup color clichés
15. random bright colors
16. generic developer-tool icon sets
17. overly simplistic layouts that feel empty instead of elegant
18. screen sets that drift into different design systems
19. inconsistent device mockups and uneven margins around the phone
20. device frames that dominate more than the actual screen content
...
- SCREEN_RHYTHM: 8 (1 = repeated screen templates, 10 = clearly differentiated screen rhythm)
...
- CONTENT_HERO_PRIORITY: 10 (1 = frame/device dominates, 10 = content remains the hero)
...
It is better to generate an extra detail image or regenerate that screen cleanly. Never reduce screen count just for convenience if it weakens the app concept.
...
Do not generate random unrelated screens. The screen order should make sense.
...
By default, show the app inside a clean phone mockup.
...
This skill should be more creative than generic app UI generators. Actively use imagery and art direction when it helps the concept.
...
- "smarter than ever"
- "transform your day"
- Fake brand slop: Acme, NovaCore, Flowbit, Quantix, VeloPay
...
**Image Art Direction Bias** – Choose 1:
...
**Texture/Surface Treatment** – Choose 1:
...
**Decorative Asset Set** – Choose exactly 2:
...
- smooth crossfade calmness
- slide-up sheet energy
...
The result should feel like a real designed product, not a reusable starter template with better lighting.
...
For first screens and onboarding especially: keep copy tight, reduce words rather than forcing more lines.
...
For premium apps: typography should feel deliberate, not loud by default.
...
- Is the design clean without being boring oversimplified?
